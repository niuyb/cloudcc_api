...
from script.data_config import OPPORTUNITY_SQL_TABLE, USER_SQL_TABLE, \
    ACCOUNT_SQL_TABLE,BIDDING_TABLE_STRING, \
    BIDDING_DICT, BIDDING_API_NAME, BIDDING_SQL_TABLE, BIDDING_CLOUMNS_ORDER
...
class Order_Data():
    def __init__(self):
        ...
        self.access_url  = ''
        self.binding = ''
        self.cloudcc_object=BIDDING_API_NAME
        self.sql_table= BIDDING_SQL_TABLE
        ...
        self.sql_index_list=[]
        self.process_num = 1
        self.columns_order = BIDDING_CLOUMNS_ORDER
