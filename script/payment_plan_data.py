...
from script.data_config import USER_SQL_TABLE, \
    ACCOUNT_SQL_TABLE, ORDER_SQL_TABLE, PAYMENT_RECORD_API_NAME, PAYMENT_RECORD_DICT, PAYMENT_RECORD_TABLE_STRING, \
    PAYMENT_RECORD_CLOUMNS_ORDER, PAYMENT_PLAN_TABLE_STRING, PAYMENT_PLAN_DICT, PAYMENT_PLAN_API_NAME, \
    PAYMENT_PLAN_SQL_TABLE, PAYMENT_PLAN_CLOUMNS_ORDER
...
class Order_Data():
    def __init__(self):
        ...
        self.access_url  = ''
        self.binding = ''
        self.cloudcc_object=PAYMENT_PLAN_API_NAME
        self.sql_table= PAYMENT_PLAN_SQL_TABLE
        ...
        self.sql_index_list=[]
        self.process_num = 1
        self.columns_order = PAYMENT_PLAN_CLOUMNS_ORDER
