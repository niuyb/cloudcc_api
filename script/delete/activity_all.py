...
from script.data_config import  ACTIVITY_TABLE_STRING, \
    ACTIVITY_DICT
...
class Order_Data():
    ...
    def get_cloudcc_order(self,index):
        ...
        # sql_field_list = list(PAYMENT_PLAN_DICT.keys())
        # print(sql_field_list)
        # sql_field_list.append("is_deleted")
        # sql_field_str = ','.join(sql_field_list)
        # print(sql_field_str)
