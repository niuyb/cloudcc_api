...
from script.data_config import ORDER_DICT, ACCOUNT_DICT, OPPORTUNITY_DICT, OPPORTUNITY_TABLE_STRING, ORDER_TABLE_STRING, \
    ORDER_CHANGE_DICT, ORDER_CHANGE_TABLE_STRING
...
class Order_Data():
    def __init__(self):
        ...
        self.access_url  = ''
        self.binding = ''
        self.cloudcc_object="ddbg"
        self.sql_table= "order_change_copy1"
        self.sql_mapping= ORDER_CHANGE_DICT
        self.sql_table_string = ORDER_CHANGE_TABLE_STRING
