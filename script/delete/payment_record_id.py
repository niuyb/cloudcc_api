...
def test():
    ...
    old_sql = """ select id,crm_id from payment_record """
...
def change():
    ...
    # department
    local_department_sql = """select `id` as owner_id ,department_id as department from {}""".format("user_back")
    local_department_df = pd.read_sql_query(local_department_sql, new_data)
