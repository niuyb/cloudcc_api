...
ORDER_DETAIL_CLOUMNS_ORDER = ["id","crm_id","order_id","owner_id","name","contract_status","attribute","product_id","contract_back_date","saler_amount","performance_acount","performance_manager","performance","account_id","amount","server_start","server_end","contract_end","created_by","created_at","updated_by","updated_at","xsy_id"]
ORDER_DETAIL_DICT={
    "id":"crm_id",
    "orderid":"order_id",
    "ownerid":"owner_id",
...
ORDER_DETAIL_TABLE_STRING = """ALTER table `{}`
                  ...
                  MODIFY `performance_manager` varchar(50) COMMENT '业绩负责人',
...
BIDDING_DICT={
    ...
    "qu": "region",
    "sqxzcy": "sales_team",
    "sjmc": "opportunity_name",
    "cloudcctag": "remark",
    "sptgsj": "approval_date",
    "shi": "city",
    "kbqk": "bid_situation",
    "kbrq": "open_bid_date",
    "sssyb": "department",
    "ownerid": "owner_id",
    "zbwjsfschuan": "is_upload",
    "bjdspzt": "quotation_status",
    "bjd": "quotation_num",
    # "ztbxmmc": "bid_name",
    # "zbggljie": "bidding_link",
    "zzbxmmc": "bidding_num",
    "zbkhmc": "bidding_account_name",
    "zbwjsfsc": "is_bid_upload",
    "zblx": "bid_type",
    "zhbh": "bidding_project_num",
    "zbxmys": "bidding_budget",
    "sqtbdlsmc": "agent_name",
    "sfqb": "bid_striving",
    "sfxysqbztbwj": "bidding_document",
    "customitem54": "account_id",
    # "wzbyixxfx": "loss_reason",
    "xjdsfndzbwj": "bid_file",
    "shenf": "province",
    "dingdan": "order_id",
    "recordtype": "record_type",
    "tgdlstbdyy": "use_agent_reason",
    "xsfzr": "sale_owner",
    "xsjd":"sale_stage",
    "xmbasj":"approval_date2",
    "xmxz":"project_nature",
    "xmlx":"project_approval",
    "xmlxbh":"project_approval_num",
    "ysbg": "report",
    "createbyid": "created_by",
    "createdate": "created_at",
    "lastmodifybyid": "updated_by",
...
"""
                          MODIFY column `loss_reason` text COMMENT '未中标原因详细分析（必填）',
                          MODIFY column `bidding_link` text COMMENT '招标公告链接',


"""

BIDDING_TABLE_STRING = """ALTER table `{}`
                          MODIFY column `id` varchar(50) COMMENT '星光自建 bouns id',
                          MODIFY column `crm_id` varchar(50) COMMENT 'crmid',
                          MODIFY column `name` varchar(150) COMMENT '提成人编号',
                          MODIFY column `winbid_link` text COMMENT '中标公告链接',
                          MODIFY column `winbid_name` varchar(50) COMMENT '中标单位名称（竞争对手）',
                          MODIFY column `winbid_date` varchar(50) COMMENT '中标日期',
                          MODIFY column `winbid_rate` varchar(50) COMMENT '中标率预估',
                          MODIFY column `winbid_notice` varchar(50) COMMENT '中标通知书',
                          MODIFY column `region` varchar(50) COMMENT '区1',
                          MODIFY column `sales_team` varchar(50) COMMENT '售前小组成员',
                          MODIFY column `opportunity_name` varchar(50) COMMENT '商机名称',
                          MODIFY column `remark` varchar(50) COMMENT '备注',
                          MODIFY column `approval_date` varchar(50) COMMENT '审批通过时间',
                          MODIFY column `city` varchar(50) COMMENT '市1',
                          MODIFY column `bid_situation` varchar(50) COMMENT '开标情况（必填）',
                          MODIFY column `open_bid_date` varchar(50) COMMENT '开标日期',
                          MODIFY column `department` varchar(50) COMMENT '所属事业部1',
                          MODIFY column `owner_id` varchar(50) COMMENT '所有人',
                          MODIFY column `is_upload` varchar(50) COMMENT '投标文件是否上传',
                          MODIFY column `quotation_status` varchar(50) COMMENT '报价单审批状态',
                          MODIFY column `quotation_num` varchar(50) COMMENT '报价单（关联商机中的报价单编号）',
                          MODIFY column `bid_name` varchar(50) COMMENT '招投标项目名称',
                          MODIFY column `bidding_num` varchar(50) COMMENT '招标备案编号',
                          MODIFY column `bidding_account_name` varchar(50) COMMENT '招标客户名称',
                          MODIFY column `is_bid_upload` varchar(50) COMMENT '招标文件是否已上传',
                          MODIFY column `bid_type` varchar(50) COMMENT '招标类型',
                          MODIFY column `bidding_project_num` varchar(50) COMMENT '招标编号（采购编号）',
                          MODIFY column `bidding_budget` varchar(50) COMMENT '招标项目预算（元）',
                          MODIFY column `agent_name` varchar(50) COMMENT '授权投标代理商名称',
                          MODIFY column `bid_striving` varchar(50) COMMENT '是否抢标',
                          MODIFY column `bidding_document` varchar(50) COMMENT '是否需要售前编制投标文件',
                          MODIFY column `account_id` varchar(50) COMMENT '最终客户名称',
                          MODIFY column `bid_file` varchar(50) COMMENT '现阶段是否拿到招标文件',
                          MODIFY column `province` varchar(50) COMMENT '省份1',
                          MODIFY column `order_id` varchar(50) COMMENT '订单',
                          MODIFY column `record_type` varchar(50) COMMENT '记录类型',
                          MODIFY column `use_agent_reason` varchar(50) COMMENT '通过代理商投标的原因',
                          MODIFY column `sale_owner` varchar(50) COMMENT '销售负责人',
                          MODIFY column `sale_stage` varchar(50) COMMENT '销售阶段',
                          MODIFY column `approval_date2` varchar(50) COMMENT '项目备案时间（审批通过时间）',
                          MODIFY column `project_nature` varchar(50) COMMENT '项目性质',
